...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource
        id="srcTicket"
        SelectCommand="SELECT * FROM ServiceTicket"
        UpdateCommand="UPDATE ServiceTicket SET TicketStatus=@TicketStatus, TicketOpenDate=@TicketOpenDate WHERE ServiceTicketID=@ServiceTicketID"
        ConnectionString="<%$ ConnectionStrings:Lab3 %>"
        Runat="server" />

        <asp:FormView
        id="FormView2"
        DataKeyNames="NoteTitle"
        DataSourceID="srcNote"
        ...
        <EditItemTemplate>
            ...
            <asp:Label
                id="lblTicketNbr"
                Text="Ticket Note: "
                AssociatedControlID="TicketNumber"
                Runat="server" />
                        </asp:TableCell>
