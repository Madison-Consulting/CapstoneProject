...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="width: auto; margin: 20px 20%">
            ...
            <asp:TableRow HorizontalAlign="Center">
                <asp:TableCell>
                    <asp:Label ID="title" runat="server" Text="Moving Form" Font-Bold="true" Font-Size="Large"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
        <br />
        <asp:Table ID="InitialMove" runat="server">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>
                   ...
                   <asp:TableRow>
                <asp:TableCell>
                    <asp:Label ID="lblOriginAddress2" runat="server" Text="Origin Address Line 2: "></asp:Label>
            ...
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Label ID="lblDestinationAddress2" runat="server" Text="Destination Address Line 2: "></asp:Label>
                </asp:TableCell>
        ...
        <asp:SqlDataSource runat="server"
            ...
            SelectCommand="SELECT Customer.CustomerID, Customer.CustFirstName + ' ' + Customer.CustLastName AS CustomerName FROM Customer;"></asp:SqlDataSource>
